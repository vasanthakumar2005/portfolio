      ...
      <div className="container">
        ...
        <div className="about-grid">
          <div className="glass-card about-text-card">
            <p className="about-p">
              I am a final-year student pursuing a <strong>Bachelor of Technology in Artificial Intelligence and Data Science</strong> at <strong>Dr. Mahalingam College of Engineering and Technology (Anna University)</strong> with an academic CGPA of <strong>8.1 / 10</strong>.
            </p>
            <p className="about-p">
            ...
            <div className="about-highlights">
              ...
              <div className="highlight-item">
                <div className="highlight-val">CGPA: 8.1 / 10</div>
